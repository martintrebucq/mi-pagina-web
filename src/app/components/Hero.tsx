...
export default function Hero() {
  ...
  return (
    <section
      id="inicio"
      className="relative flex flex-col min-h-screen px-4 sm:px-6 overflow-hidden"
      aria-label="Sección principal - Powerfly Connect"
    >
      {/* Fondo cuadriculado */}
      <div
      ...
      >
        ...
        >
          ...
          <div className="flex items-center">
            <Link
              ...
              aria-label="Visitar Powerfly Agency"
            >
              <Image
                src="/logo-color.png"
                alt="Powerfly Agency - Logo principal"
                width={120}
                height={44}
                priority
          ...
          <div className="hidden lg:flex items-center space-x-8" role="menubar">
            {menuItems.map((item) => (
              ...
              >
                ...
                <span
                  className="absolute left-0 bottom-0 w-0 h-0.5 bg-[#395ef4] transition-all duration-300 group-hover:w-full"
                  style={{ height: "1px" }}
                />
              </a>
            ))}
          ...
          >
            <a
              ...
              aria-label="Seguir Powerfly Agency en Instagram"
            >
              <FaInstagram size={30} />
            </a>
            <a
              ...
              aria-label="Conectar con Powerfly Agency en LinkedIn"
            >
              <FaLinkedin size={30} />
            </a>
          </div>
        ...
        {menuOpen && (
          <nav
            className="lg:hidden mt-3 pt-3 border-t border-gray-200 bg-white/95 backdrop-blur-md rounded-xl shadow-lg -mx-3 sm:-mx-6 px-3 sm:px-6 py-3"
            id="mobile-menu"
            role="navigation"
            aria-label="Menú móvil"
          >
            <div className="flex flex-col space-y-2.5" role="menubar">
              {menuItems.map((item) => (
                <a
                  key={item.label}
                  href={item.href}
            ...
            <div
              className="flex items-center justify-center space-x-4 mt-5 pt-3 border-t border-gray-200"
              role="complementary"
              aria-label="Redes sociales móviles"
            >
              <a
                href="https://www.instagram.com/powerfly.agency/"
                target="_blank"
      ...
      <div className="relative z-10 flex flex-col justify-center items-center min-h-screen w-full max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-36 sm:pt-40">
        ...
        <div
          className={`max-w-4xl text-gray-900 transition-all duration-700 mb-6 sm:mb-8 ${
        ...
        >
          ...
          <p className="text-sm sm:text-lg lg:text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed mb-5 sm:mb-8 px-1">
            ...
            impulsamos tu empresa con soluciones digitales que crecen junto a
            vos.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 mb-5 sm:mb-10">
            <a
              ...
              aria-label="Probar Powerfly Connect - Contactar por WhatsApp"
            >
          ...
          <div className="text-center mb-4 sm:mb-6">
            <p className="text-gray-500 font-medium text-[11px] sm:text-sm leading-snug max-w-[220px] sm:max-w-none mx-auto sm:flex sm:items-center sm:justify-center sm:gap-2">
              <span
                className="inline-block w-2 h-2 bg-green-500 rounded-full align-middle mr-2 sm:mr-0"
                aria-hidden="true"
              />
              <span>
                Más de{" "}
                <span className="text-gray-700 font-semibold">50 empresas</span>
            ...
            <div className="marquee fade-mask will-change-transform">
              <div className="marquee__track">
                {integrationLogos.map((logo, i) => (
                  <div
                    key={`a-${i}`}
                    className="flex-shrink-0 w-28 sm:w-32 flex items-center justify-center px-4 py-3"
                  >
                    <Image
                      src={logo.url}
                      alt={logo.alt}
